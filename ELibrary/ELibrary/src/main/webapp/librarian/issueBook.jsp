		...
		<div class="mainBar" style="margin-left: 15%">
			<div class="form1">
				...
				<div class="w3-card-4 table">
					...
					<form class="w3-container" action="../searchBook" method="post">

												<label>Book SNO </label> <input class="w3-input w3-border"
							name="bookSno" type="text" required>
						
							<button class="w3-btn  w3-blue-grey w3-hover-amber">Search
								Book</button>
