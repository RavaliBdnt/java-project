...
<body>
	...
	<div class="form1">
		...
		<div class="w3-card-4">
			...
			<form class="w3-container" action="adminLogin" method="post">

				<label>Email id</label> <input class="w3-input w3-border"
					name="email" type="email" required> <label>Password</label>
