	...
	<div class="mainContent">
		<div class="form1">
			...
			<div class="w3-card-4 table">
				...
				<form action="../editTruckByManager" method="post"
					...
					<label>Truck Number</label> <input class="w3-input w3-border"
						name="truckNumber" value="<%=truck.getTruckNumber()%>" type="text"
						required> <label>Company Name</label> <input
						class="w3-input w3-border" value="<%=truck.getCompanyName()%>"
						name="companyName" type="text" required> <label>Purchase
						Date</label> <input class="w3-input w3-border"
						value="<%=truck.getPurchaseDate()%>" name="pd" type="Date"
						required> <label>Image</label> <input
						class="w3-input w3-border" name="image" type="file">
					<br>
					<div class="w3-center">
