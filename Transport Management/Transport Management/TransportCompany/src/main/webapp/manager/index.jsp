...
<body>
	...
	List<Truck> noOfTruckByBranchName = dao.getTruckByBranch(branchName);
	...
	<div class="main">
		...
		<div class="row table" >
			...
			<div class="w3-card w3-quarter" style="cursor: pointer;" onclick="window.location='/TransportCompany/manager/viewInstalledTrucks.jsp?branchName=<%=branchName %>';">
				<div class="w3-center">
					<img src="/TransportCompany/img/comments.png" width="100px"
						height="100px">
					<h4>Total Truck of <%= branchName %></h4>
					<h3><%= noOfTruckByBranchName.size()  %></h3>
				</div>
			</div>
